...
def run_model_DBLP(args):
    ...
    g.edges(): 
    (
        tensor([    0,     0,     0,  ..., 21417, 21418, 21419], device='cuda:4'), 
        tensor([ 5851,  8129, 10128,  ..., 21417, 21418, 21419], device='cuda:4')
        )
    e_feat:
    tensor([0, 2, 2,  ..., 6, 6, 6], device='cuda:4')   e_feat shape:  torch.Size([108062])
    """
